...
const mongoose = require("mongoose"),
  dbURL = "mongodb+srv://ut-node:jVHX5X1YsuJwWwc4@ut-node.u13qncj.mongodb.net/?retryWrites=true&w=majority&appName=UT-Node", // Atlas에서 
  dbName = "ut-node";
...
let sub1 = new Subscriber({
  name: "jeonghan",
  email: "jeonghan.trainer@gmail.com",
  phone: 123456789,
  newsletter: true
});
